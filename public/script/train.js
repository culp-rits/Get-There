            ...
            for (let i in x){
                ...
                if(x[i].travel_mode == "TRANSIT"){
                    if(x[i].transit.line.short_name != undefined){
                        ...
                        p.innerHTML = x[i].transit.line.vehicle.name + " - " + x[i].transit.line.name + "<br>Arrival Time - " + x[i].transit.departure_time.text + "<br>" + x[i].instructions + "<br>From - " + x[i].transit.departure_stop.name + "<br>To - " + x[i].transit.arrival_stop.name
                    }
                }
                else{
                    const z = x[i].steps
